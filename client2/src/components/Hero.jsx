...
export default function Hero() {
  return (
    <div className="pb-28 -mt-8 bg-[#141417] h-min-h-screen">
      <div className="container mx-auto overflow-y-hidden overflow-x-hidden">
        <div className="flex justify-around flex-wrap items-center">
          <div className="w-full pl-5 sm:pt-5 pt-0 pr-5 sm:pb-5 pb-0 lg:w-1/2 lg:pr-0">
            <h1 className="title lg:text-8xl max-xs:text-5xl mb-6 text-[2.8rem] font-bold leading-none tracking-tight md:text-8xl text-gray-100">
              Seu coach de currículo
              e
              candidatura
            ...
            <p className="mt-5 sm:mb-9 mb-0 text-lg font-medium text-gray-100 max-xl:max-w-sm md:text- text-justify">
              Alimentado por Inteligência Artificial generativa, o ResumeAI
              é um coach de currículo e candidatura que te ajuda a se destacar
          ...
          <div className="p-0">
            <div className="">
              <svg className="w-full" height="512" viewBox="0 0 512 512" fill="none" overflow="hidden" xmlns="http://www.w3.org/2000/svg">
