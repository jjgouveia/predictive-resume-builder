...
export default function HowItWorks() {
  return (
    <section id="como-funciona" className="overflow-hidden bg-slate-100 py-32">
                  ...
                  <div className="xs:p-6 flex-1 pb-6">
                    <div>
                      ...
                      <p className="font-medium leading-relaxed text-gray-700">
                        Preencha o formulário de cadastro com seus dados
                        e algumas referências profissionais.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="xs:-m-6 max-xs:flex- gap-3 flex flex-wrap">
                  ...
                  <div className="xs:p-6 flex-1 pb-6">
                    <div>
                      ...
                      <p className="font-medium leading-relaxed text-gray-700">
                        Escolha o plano que mais se adeque às
                        suas necessidades e momento profissional.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="xs:-m-6 max-xs:flex- gap-3 flex flex-wrap">
                  ...
                  <div className="xs:p-6 flex-1 pb-6">
                    <div>
                      ...
                      <p className="font-medium leading-relaxed text-gray-700">
                        Agora é por nossa conta! Crieremos o seu currículo com base
