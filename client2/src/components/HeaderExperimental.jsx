...
export default function Header() {
  ...
  return (
    <header className="bg-[#141417] flex justify-between items-center w-full mt-0 pb-1 sm:px-4 px-2 border-b border-gray-100">
      <div className="relative w-full flex items-center justify-between bg-transparent py-4 lg:px-4">
        <div className="w-auto">
          <div className="flex flex-wrap items-center">
            <div
              className="mr-14 w-auto"
              onClick={
        () => navigate('/')
      }
              role="button"
              ...
              onKeyDown={() => navigate('/')}
            >
              <h1 className="text-gray-100 sm:text-4xl text-4xl font-semibold ml-2 tracking-tight m-0.5 sm:m-2">
                ResumeAI
                {' '}
        ...
        () => navigate('/')
                  ...
                  >
                    <h1 className="flex items-end h-auto text-gray-900 sm:text-3xl text-2xl font-semibold tracking-tight">
                      ResumeAI
                      {' '}
                      <span className="text-xs pl-1 pb-1 text-slate-400">beta</span>
                    </h1>
